...
const MOCK_MENU = [
  // --- BURGERS TEMÁTICOS ---
  {
    id: 'pac-man',
    name: 'PAC MAN',
    description: 'Pão de brioche, burguer de 120g, alface americana, cebola roxa, tomate, geleia de bacon, queijo e maionese da casa.',
    price: 32.90,
    imageUrl: '', 
    category: 'burgers',
    isHighlight: true,
  ...
  },
  {
    id: 'princesa-peach',
    name: 'PRINCESA PEACH',
    description: 'Pão rosa, burguer de 120g, queijo prato gratinado e maionese da casa.',
    price: 19.90,
    imageUrl: '',
    category: 'burgers',
    isHighlight: false,
